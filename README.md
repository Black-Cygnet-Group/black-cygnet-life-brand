...
The canonical 33-page brand guide is in [`guidelines/black-cygnet-life-brand-guide.pdf`](./guidelines/black-cygnet-life-brand-guide.pdf). It covers brand manifesto, personality archetypes, logo usage, colour, typography, patterns, photography treatment, and application examples.
